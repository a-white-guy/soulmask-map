...
// atr.push(`<a href="https://github.com/Kregap/game-map-core">Core v${coreVersion}</a>`) // remove unneeded link <----------------------------------------
atr.forEach((a) => {
...
flags.forEach(flag => {
// flag.addTo(map) // removed language icons <----------------------------------------
})
...
// communityButton.addTo(map) // removed button <----------------------------------------
// creditsButton.addTo(map) // removed button <----------------------------------------
